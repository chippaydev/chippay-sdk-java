package com.chippay.sdk.test;

import com.chippay.sdk.ApiV1;
import com.chippay.sdk.ApiV2;
import com.chippay.sdk.util.Utils;
...
public class TestApi {
    ...
    public void TestV1Api() throws Exception{
        ...
        params.put("syncUrl","https://demo.chippaytest.com");
        params.put("asyncUrl","https://demo.chippaytest.com");

        ApiV1 apiV1 = new ApiV1("b7ef76e3b52a9d793d98fd6a3d92d6cf");

        String resp = apiV1.call("https://open-v2.chippaytest.com/cola/order/addOrder",params);
    ...
    public void TestV2Api() throws Exception{
        ...
        String resp = apiV2.call("https://open-v2.chippaytest.com/cola/apiOpen/addOrder",params);
